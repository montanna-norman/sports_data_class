...
The results display 735 rows and 30 different stat columns. Most of the stats are actual numbers, like games played, minutes, and shooting percentages, while a few are text, like player name, team, and position.
...
**Answer** DESCRIBE THE RESULTS HERE
The data set contains more shooting guards than any other position, and power forwards are the fewest.
...
Like the data above, the results show that shooting guards are the most common.
...
**ANSWER** I think shooting guard (SG) is the most interesting to me because there are way more players at that position than any other. A possible story here could be diving into some research as to why NBA teams have so many shooting guards.
nbaplayers <- read_csv("~/SportsData/nbaadvancedplayers2425.csv")